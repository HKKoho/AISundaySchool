...
import { User, Sprout, Mountain, Footprints, Heart, BookOpen, HandHeart, MessageCircle } from 'lucide-react';
...
export const GameCanvas: React.FC<GameCanvasProps> = ({
  ...
  const getSoilIcon = (visitor: Visitor) => {
    ...
    switch (visitor.soilType) {
      ...
      case SoilType.THORNS: return <Sprout className="text-green-600" size={24} />;

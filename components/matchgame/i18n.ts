...
export const translations: Translations = {
  en: {
    ...
    challengeTitle: "Ready for a Challenge!",
    challengeDesc: "You have excellent biblical knowledge! We challenge you to dive deeper into each chapter of the Bible for advanced study.",
    recommendTitle: "Recommendation",
    recommendDesc: "We recommend joining a Sunday School class or Bible Study group to strengthen your foundation in Scripture.",
    backToHome: "Back to Home",
    goDeeper: "Go Deeper in Bible",
    underConstructionTitle: "Under Construction",
    underConstructionMessage: "This feature is coming soon! We are working hard to bring you deeper Bible study content.",
    gameRounds: [
      {
        id: 1,
  ...
  'zh-TW': {
    ...
    challengeTitle: "準備好接受挑戰！",
    challengeDesc: "你擁有出色的聖經知識！我們挑戰你深入研讀聖經的每一章節，進行進階學習。",
    recommendTitle: "建議",
    recommendDesc: "我們建議參加主日學課程或聖經研讀小組，以加強你對聖經的基礎認識。",
    backToHome: "返回首頁",
    goDeeper: "深入研讀聖經",
    underConstructionTitle: "建置中",
    underConstructionMessage: "此功能即將推出！我們正在努力為您帶來更深入的聖經研讀內容。",
    gameRounds: [
      {
        id: 1,
        category: "族長們和他們的旅程",
